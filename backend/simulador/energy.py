"""Integracao de energia entre leituras consecutivas do simulador, por trapezio.
...
TODO(M2): quando o servico de polling completo existir, mover esta funcao para
`app/services/energy_integration.py` e importar dali aqui, para nao duplicar a formula.
"""
